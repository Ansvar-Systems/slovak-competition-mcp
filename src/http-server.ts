...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across PMU enforcement decisions (abuse of dominance, cartel, sector inquiries). Returns matching decisions with case number, parties, outcome, fine amount, and GWB articles cited.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'zneužívanie dominantného postavenia, kartel')" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific PMU decision by case number (e.g., 'B6-22/16').",
    inputSchema: {
      type: "object" as const,
      properties: {
        case_number: { type: "string", description: "Case number (e.g., '2023/PM/1/1/001')" },
      },
  ...
  },
  {
    ...
    description:
      "Search PMU merger control decisions (Fusionskontrolle).",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'koncentrácia, prevzatie')" },
        sector: { type: "string", description: "Filter by sector ID. Optional." },
        outcome: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "List all sectors with PMU enforcement activity, including decision and merger counts.",
      ...
      switch (name) {
        ...
        case "sk_comp_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "PMU (German Federal Cartel Office) MCP server. Provides access to German competition law enforcement decisions, merger control cases, and sector enforcement data under the GWB (Gesetz gegen Wettbewerbsbeschränkungen).",
            data_source: "PMU (https://www.bundeskartellamt.de/)",
